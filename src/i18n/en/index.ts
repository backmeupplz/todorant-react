...
export default {
  ...
  landingShort: {
    ...
    act: 'Act!',
    contact: ['Still got questions? Contact me directly at ', '. Thank you. '],
  ...
  feedback: {
    ...
    reviews: [
      ...
      },
      {
        ...
        text: 'Thanks for the great service. Enough time has passed so that I can say — it helps me. Thanks, Nikita 😁 And good luck with the app.',
      },
      {
        name: 'Igor Malinkin',
        username: 'sxe4kilo',
